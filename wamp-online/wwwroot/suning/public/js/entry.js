...
$(function(){
	$('.floor-tab li').mouseover(function(){
		var num= $(this).index('.floor-tab li');
			$(".floor-tab li").eq(num).addClass('on').siblings(".floor-tab li").removeClass('on');		
		$(".floor-main").eq(num).stop().fadeIn().siblings(".floor-main").stop().fadeOut();
	})
})
