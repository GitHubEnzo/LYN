...
<if value="isset($_GET['isajax'])">
	...
	<else/>
	<!--<body style="background: url('{{__ROOT__}}/resource/images/bg.jpg') no-repeat ;background-size: cover">-->
	<!--导航-->
	<!--<if value="!IS_MOBILE">
			...
			<div class="container-fluid">
				<div class="navbar-header">
					<ul class="nav navbar-nav">
						<li>
							<a href="{{u('entry.index')}}" target="_blank"><i class="fa fa-w fa-forumbee"></i> 苏宁首页</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<!--导航end-->
	<div id="" style="background: url('{{__ROOT__}}/resource/images/bg.jpg') no-repeat ;background-size: cover ;height: 600px;margin-top: 50px;">
		<div class="container-fluid">
