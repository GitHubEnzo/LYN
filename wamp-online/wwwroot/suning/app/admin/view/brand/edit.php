...
<block name="content">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="active"><a href="{{u('edit')}}">品牌编辑</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="bname" class="form-control" value="{{$olddata['bname']}}">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">品牌排序</label>
                    <div class="col-sm-9">
                        <input type="number" name="sort"  class="form-control" value="{{$olddata['sort']}}">
                    </div>
                </div>
                <div class="form-group">
