...
<div class="wrapper floor floor1"  style="margin-bottom:20px ">
	...
	<?php }else{?>
		...
		<!--左侧广告-->
		<div class="side">
			<a href="<?php echo u('goods.index',['gid'=>$v[goodData][8][gid],'tid'=>$v[goodData][8][tid]])?>" class="side-img"style="background: white">
				<p class="title" style="color: #f15453;"><?php echo $v[goodData][8][gname]?> </p>
				<p class="desc" style="color: #f15453;">1元定金翻百倍</p>
				<img alt="1元定金翻百倍" style="width: 200px;height: 200px;position: absolute;top: 10px" class="lazy-loading" src="<?php echo $v[goodData][8][pic]?>">
			...
			<div class="last-img">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][7][gid],'tid'=>$v[goodData][7][tid]])?>">
					<p class="title" ><?php echo $v[goodData][7][gname]?></p>
					<p class="desc" style="color: #f15453;">大牌满399立减20</p>
					<img  alt="大牌满399立减20" class="lazy-loading" src="<?php echo $v[goodData][7][pic]?>">
				</a>
			</div>
		</div>
		<!--右侧广告-->
		<div class="main-cont">
			<div class="slider">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][6][gid],'tid'=>$v[goodData][6][tid]])?>">
				<p class="title" style="font-size: 20px"><?php echo $v[goodData][6][gname]?></p>
				<p class="desc" style="color: #f15453; font-size: 20px">大牌满399立减20</p>
				<img style="width: 200px;height: 200px;float: right;" src="<?php echo $v[goodData][6][pic]?>" alt="" />
				</a>
			</div>
			<ul class="col1">
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][5][gid],'tid'=>$v[goodData][5][tid]])?>">
						<p class="title"><?php echo $v[goodData][5][gname]?></p>
						<p class="desc" style="color:#f15453;">跨店铺3免一</p>
						<img alt="跨店铺3免一" class="lazy-loading" src="<?php echo $v[goodData][5][pic]?>">
					</a>
				</li>
				<li>
			...
			<ul class="col2">
				<li>
					<a d-href="http://re.suning.com/category/340558-3/" d-title="新品潮流豆豆鞋" rel="nofollow" target="_blank" name="index3_homepage1_18437410295_pic01" href="<?php echo u('goods.index',['gid'=>$v[goodData][3][gid],'tid'=>$v[goodData][3][tid]])?>" title="新品潮流豆豆鞋">
						<p class="title" d-content="新品潮流豆豆鞋"><?php echo $v[goodData][3][gname]?></p>
						<p class="desc" style="color:#f15453;" d-content="男士英伦真皮驾车鞋">买买买</p>
						<img cpmid="100003323" style="width: 145px;height: 145px" d-src="//image1.suning.cn/uimg/aps/material/147677458924326356.jpg" d-alt="男士英伦真皮驾车鞋" src="<?php echo $v[goodData][3][pic]?>" alt="新品潮流豆豆鞋">
					</a>
				</li>
				<li>
					<a d-href="http://product.suning.com/0070118218/136337628.html" d-title="双11提前购" rel="nofollow" target="_blank" name="index3_homepage1_18437410295_pic02" href="<?php echo u('goods.index',['gid'=>$v[goodData][2][gid],'tid'=>$v[goodData][2][tid]])?>" title="双11钟表会场">
						<p class="title" d-content="双11提前购"><?php echo $v[goodData][2][gname]?></p>
						<p class="desc" style="color:#f15453;" d-content="买就送袜子">每满100立减10元</p>
						<img cpmid="100003324" style="width: 145px;height: 145px" d-src="//image5.suning.cn/uimg/aps/material/147763919462167059.jpg" d-alt="买就送袜子" src="<?php echo $v[goodData][2][pic]?>" alt="双11钟表会场">
					</a>
				</li>
			</ul>
			<ul class="col2">
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][1][gid],'tid'=>$v[goodData][1][tid]])?>" rel="nofollow" target="_blank" name="index3_homepage1_18437410296_pic01" title="双11钟表节">
						<p class="title"><?php echo $v[goodData][1][gname]?></p>
						<p class="desc" style="color:#f15453;">每满1999减50</p>
						<img alt="每满1999减50" style="width: 145px;height: 145px" class="lazy-loading" src="<?php echo $v[goodData][1][pic]?>">
					</a>
				</li>
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][0][gid],'tid'=>$v[goodData][0][tid]])?>" rel="nofollow" target="_blank" name="index3_homepage1_18437410296_pic02" title="弹棉之家">
						<p class="title"><?php echo $v[goodData][0][gname]?></p>
						<p class="desc" style="color:#f15453;">79买一送一</p>
						<img alt="79买一送一" style="width: 145px;height: 145px" class="lazy-loading" src="<?php echo $v[goodData][0][pic]?>">
					</a>
				</li>
			</ul>
		</div>
	...
	<div class="floor-main" style="display:none">
		<!--左侧广告-->
		<div class="side">
			<a href="<?php echo u('goods.index',['gid'=>$v[goodData][3][gid],'tid'=>$v[goodData][3][tid]])?>" class="side-img"style="background: white">
				<p class="title" style="color: #f15453;"><?php echo $v[goodData][3][gname]?> </p>
				<p class="desc" style="color: #f15453;">1元定金翻百倍</p>
				<img alt="1元定金翻百倍" style="width: 200px;height: 200px;position: absolute;top: 10px" class="lazy-loading" src="<?php echo $v[goodData][3][pic]?>">
				<i class="roll" style="border-color: transparent transparent transparent #f15453;"></i>
			</a>
			<ul class="entrances">
				<?php if(!empty($v[cname1])){ foreach ($v[cname1] as $kk=>$vv){?>
			...
			<div class="last-img">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][4][gid],'tid'=>$v[goodData][4][tid]])?>">
					<p class="title" ><?php echo $v[goodData][4][gname]?></p>
					<p class="desc" style="color: #f15453;">大牌满399立减20</p>
					<img  alt="大牌满399立减20" class="lazy-loading" src="<?php echo $v[goodData][4][pic]?>">
				</a>
			</div>
		</div>
		<!--右侧广告-->
		<div class="main-cont">
			<div class="slider">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][5][gid],'tid'=>$v[goodData][5][tid]])?>">
				<p class="title" style="font-size: 20px"><?php echo $v[goodData][5][gname]?></p>
				<p class="desc" style="color: #f15453; font-size: 20px">大牌满399立减20</p>
				<img style="width: 200px;height: 200px;float: right;" src="<?php echo $v[goodData][5][pic]?>" alt="" />
				</a>
			</div>
			<ul class="col1">
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][6][gid],'tid'=>$v[goodData][6][tid]])?>">
						<p class="title"><?php echo $v[goodData][6][gname]?></p>
						<p class="desc" style="color:#f15453;">跨店铺3免一</p>
						<img alt="跨店铺3免一" class="lazy-loading" src="<?php echo $v[goodData][6][pic]?>">
					</a>
				</li>
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][7][gid],'tid'=>$v[goodData][7][tid]])?>">
						<p class="title"><?php echo $v[goodData][7][gname]?></p>
						<p class="desc" style="color:#f15453;">报价双11提前购</p>
						<img alt="跨店铺3免一" class="lazy-loading"  src="<?php echo $v[goodData][7][pic]?>">
					</a>
				</li>
			</ul>
			<ul class="col2">
				<li>
					<a d-href="http://re.suning.com/category/340558-3/" d-title="新品潮流豆豆鞋" rel="nofollow" target="_blank" name="index3_homepage1_18437410295_pic01" href="<?php echo u('goods.index',['gid'=>$v[goodData][8][gid],'tid'=>$v[goodData][8][tid]])?>" title="新品潮流豆豆鞋">
						<p class="title" d-content="新品潮流豆豆鞋"><?php echo $v[goodData][8][gname]?></p>
						<p class="desc" style="color:#f15453;" d-content="男士英伦真皮驾车鞋">买买买</p>
						<img cpmid="100003323" style="width: 145px;height: 145px" d-src="//image1.suning.cn/uimg/aps/material/147677458924326356.jpg" d-alt="男士英伦真皮驾车鞋" src="<?php echo $v[goodData][8][pic]?>" alt="新品潮流豆豆鞋">
					</a>
				</li>
				<li>
					<a d-href="http://product.suning.com/0070118218/136337628.html" d-title="双11提前购" rel="nofollow" target="_blank" name="index3_homepage1_18437410295_pic02" href="<?php echo u('goods.index',['gid'=>$v[goodData][0][gid],'tid'=>$v[goodData][0][tid]])?>" title="双11钟表会场">
						<p class="title" d-content="双11提前购"><?php echo $v[goodData][0][gname]?></p>
						<p class="desc" style="color:#f15453;" d-content="买就送袜子">每满100立减10元</p>
						<img cpmid="100003324" style="width: 145px;height: 145px" d-src="//image5.suning.cn/uimg/aps/material/147763919462167059.jpg" d-alt="买就送袜子" src="<?php echo $v[goodData][0][pic]?>" alt="双11钟表会场">
					</a>
				</li>
			</ul>
			<ul class="col2">
				...
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][2][gid],'tid'=>$v[goodData][2][tid]])?>" rel="nofollow" target="_blank" name="index3_homepage1_18437410296_pic02" title="弹棉之家">
						<p class="title"><?php echo $v[goodData][2][gname]?></p>
						<p class="desc" style="color:#f15453;">79买一送一</p>
						<img alt="79买一送一" style="width: 145px;height: 145px" class="lazy-loading" src="<?php echo $v[goodData][2][pic]?>">
					</a>
				</li>
			</ul>
		</div>
	...
	<div class="floor-main" style="display:none">
		<!--左侧广告-->
		<div class="side">
			<a href="<?php echo u('goods.index',['gid'=>$v[goodData][5][gid],'tid'=>$v[goodData][5][tid]])?>" class="side-img"style="background: white">
				<p class="title" style="color: #f15453;"><?php echo $v[goodData][5][gname]?> </p>
				<p class="desc" style="color: #f15453;">1元定金翻百倍</p>
				<img alt="1元定金翻百倍" style="width: 200px;height: 200px;position: absolute;top: 10px" class="lazy-loading" src="<?php echo $v[goodData][5][pic]?>">
				<i class="roll" style="border-color: transparent transparent transparent #f15453;"></i>
			</a>
			<ul class="entrances">
				<?php if(!empty($v[cname1])){ foreach ($v[cname1] as $kk=>$vv){?>
			...
			<div class="last-img">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][6][gid],'tid'=>$v[goodData][6][tid]])?>">
					<p class="title" ><?php echo $v[goodData][6][gname]?></p>
					<p class="desc" style="color: #f15453;">大牌满399立减20</p>
					<img  alt="大牌满399立减20" class="lazy-loading" src="<?php echo $v[goodData][6][pic]?>">
				</a>
			</div>
		</div>
		<!--右侧广告-->
		<div class="main-cont">
			<div class="slider">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][7][gid],'tid'=>$v[goodData][7][tid]])?>">
				<p class="title" style="font-size: 20px"><?php echo $v[goodData][7][gname]?></p>
				<p class="desc" style="color: #f15453; font-size: 20px">大牌满399立减20</p>
				<img style="width: 200px;height: 200px;float: right;" src="<?php echo $v[goodData][7][pic]?>" alt="" />
				</a>
			</div>
			<ul class="col1">
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][8][gid],'tid'=>$v[goodData][8][tid]])?>">
						<p class="title"><?php echo $v[goodData][8][gname]?></p>
						<p class="desc" style="color:#f15453;">跨店铺3免一</p>
						<img alt="跨店铺3免一" class="lazy-loading" src="<?php echo $v[goodData][8][pic]?>">
					</a>
				</li>
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][0][gid],'tid'=>$v[goodData][0][tid]])?>">
						<p class="title"><?php echo $v[goodData][0][gname]?></p>
						<p class="desc" style="color:#f15453;">报价双11提前购</p>
						<img alt="跨店铺3免一" class="lazy-loading"  src="<?php echo $v[goodData][0][pic]?>">
					</a>
				</li>
			</ul>
			<ul class="col2">
				<li>
					<a d-href="http://re.suning.com/category/340558-3/" d-title="新品潮流豆豆鞋" rel="nofollow" target="_blank" name="index3_homepage1_18437410295_pic01" href="<?php echo u('goods.index',['gid'=>$v[goodData][1][gid],'tid'=>$v[goodData][1][tid]])?>" title="新品潮流豆豆鞋">
						<p class="title" d-content="新品潮流豆豆鞋"><?php echo $v[goodData][1][gname]?></p>
						<p class="desc" style="color:#f15453;" d-content="男士英伦真皮驾车鞋">买买买</p>
						<img cpmid="100003323" style="width: 145px;height: 145px" d-src="//image1.suning.cn/uimg/aps/material/147677458924326356.jpg" d-alt="男士英伦真皮驾车鞋" src="<?php echo $v[goodData][1][pic]?>" alt="新品潮流豆豆鞋">
					</a>
				</li>
				<li>
					<a d-href="http://product.suning.com/0070118218/136337628.html" d-title="双11提前购" rel="nofollow" target="_blank" name="index3_homepage1_18437410295_pic02" href="<?php echo u('goods.index',['gid'=>$v[goodData][2][gid],'tid'=>$v[goodData][2][tid]])?>" title="双11钟表会场">
			...
			<ul class="col2">
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][3][gid],'tid'=>$v[goodData][3][tid]])?>" rel="nofollow" target="_blank" name="index3_homepage1_18437410296_pic01" title="双11钟表节">
						<p class="title"><?php echo $v[goodData][3][gname]?></p>
						<p class="desc" style="color:#f15453;">每满1999减50</p>
						<img alt="每满1999减50" style="width: 145px;height: 145px" class="lazy-loading" src="<?php echo $v[goodData][3][pic]?>">
					</a>
				</li>
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][4][gid],'tid'=>$v[goodData][4][tid]])?>" rel="nofollow" target="_blank" name="index3_homepage1_18437410296_pic02" title="弹棉之家">
						<p class="title"><?php echo $v[goodData][4][gname]?></p>
						<p class="desc" style="color:#f15453;">79买一送一</p>
						<img alt="79买一送一" style="width: 145px;height: 145px" class="lazy-loading" src="<?php echo $v[goodData][4][pic]?>">
					</a>
				</li>
			</ul>
		</div>
	...
	<div class="floor-main" style="display:none">
		<!--左侧广告-->
		<div class="side">
			<a href="<?php echo u('goods.index',['gid'=>$v[goodData][7][gid],'tid'=>$v[goodData][7][tid]])?>" class="side-img"style="background: white">
				<p class="title" style="color: #f15453;"><?php echo $v[goodData][7][gname]?> </p>
				<p class="desc" style="color: #f15453;">1元定金翻百倍</p>
				<img alt="1元定金翻百倍" style="width: 200px;height: 200px;position: absolute;top: 10px" class="lazy-loading" src="<?php echo $v[goodData][7][pic]?>">
				<i class="roll" style="border-color: transparent transparent transparent #f15453;"></i>
			</a>
			<ul class="entrances">
				<?php if(!empty($v[cname1])){ foreach ($v[cname1] as $kk=>$vv){?>
			...
			<div class="last-img">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][8][gid],'tid'=>$v[goodData][8][tid]])?>">
					<p class="title" ><?php echo $v[goodData][8][gname]?></p>
					<p class="desc" style="color: #f15453;">大牌满399立减20</p>
					<img  alt="大牌满399立减20" class="lazy-loading" src="<?php echo $v[goodData][8][pic]?>">
				</a>
			</div>
		</div>
		<!--右侧广告-->
		<div class="main-cont">
			<div class="slider">
				<a href="<?php echo u('goods.index',['gid'=>$v[goodData][0][gid],'tid'=>$v[goodData][0][tid]])?>">
				<p class="title" style="font-size: 20px"><?php echo $v[goodData][0][gname]?></p>
				<p class="desc" style="color: #f15453; font-size: 20px">大牌满399立减20</p>
				<img style="width: 200px;height: 200px;float: right;" src="<?php echo $v[goodData][0][pic]?>" alt="" />
				</a>
			</div>
			<ul class="col1">
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][1][gid],'tid'=>$v[goodData][1][tid]])?>">
						<p class="title"><?php echo $v[goodData][1][gname]?></p>
						<p class="desc" style="color:#f15453;">跨店铺3免一</p>
						<img alt="跨店铺3免一" class="lazy-loading" src="<?php echo $v[goodData][1][pic]?>">
					</a>
				</li>
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][2][gid],'tid'=>$v[goodData][2][tid]])?>">
						<p class="title"><?php echo $v[goodData][2][gname]?></p>
						<p class="desc" style="color:#f15453;">报价双11提前购</p>
						<img alt="跨店铺3免一" class="lazy-loading"  src="<?php echo $v[goodData][2][pic]?>">
					</a>
				</li>
			</ul>
			<ul class="col2">
				...
				<li>
					<a d-href="http://product.suning.com/0070118218/136337628.html" d-title="双11提前购" rel="nofollow" target="_blank" name="index3_homepage1_18437410295_pic02" href="<?php echo u('goods.index',['gid'=>$v[goodData][4][gid],'tid'=>$v[goodData][4][tid]])?>" title="双11钟表会场">
						<p class="title" d-content="双11提前购"><?php echo $v[goodData][4][gname]?></p>
						<p class="desc" style="color:#f15453;" d-content="买就送袜子">每满100立减10元</p>
						<img cpmid="100003324" style="width: 145px;height: 145px" d-src="//image5.suning.cn/uimg/aps/material/147763919462167059.jpg" d-alt="买就送袜子" src="<?php echo $v[goodData][4][pic]?>" alt="双11钟表会场">
					</a>
				</li>
			</ul>
			<ul class="col2">
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][5][gid],'tid'=>$v[goodData][5][tid]])?>" rel="nofollow" target="_blank" name="index3_homepage1_18437410296_pic01" title="双11钟表节">
						<p class="title"><?php echo $v[goodData][5][gname]?></p>
						<p class="desc" style="color:#f15453;">每满1999减50</p>
						<img alt="每满1999减50" style="width: 145px;height: 145px" class="lazy-loading" src="<?php echo $v[goodData][5][pic]?>">
					</a>
				</li>
				<li>
					<a href="<?php echo u('goods.index',['gid'=>$v[goodData][6][gid],'tid'=>$v[goodData][6][tid]])?>" rel="nofollow" target="_blank" name="index3_homepage1_18437410296_pic02" title="弹棉之家">
						<p class="title"><?php echo $v[goodData][6][gname]?></p>
						<p class="desc" style="color:#f15453;">79买一送一</p>
						<img alt="79买一送一" style="width: 145px;height: 145px" class="lazy-loading" src="<?php echo $v[goodData][6][pic]?>">
					</a>
				</li>
			</ul>
		</div>
