...
<?php if(isset($_GET['isajax'])){?>
	...
	<?php }else{?>
	<!--<body style="background: url('<?php echo __ROOT__?>/resource/images/bg.jpg') no-repeat ;background-size: cover">-->
	<!--导航-->
	<!--<?php if(!IS_MOBILE){?>
			...
			<div class="container-fluid">
				<div class="navbar-header">
					<ul class="nav navbar-nav">
						<li>
							<a href="<?php echo u('entry.index')?>" target="_blank"><i class="fa fa-w fa-forumbee"></i> 苏宁首页</a>
						</li>
					</ul>
				</div>
			</div>
               ...
               <?php }?>-->
	<!--导航end-->
	<div id="" style="background: url('<?php echo __ROOT__?>/resource/images/bg.jpg') no-repeat ;background-size: cover ;height: 600px;margin-top: 50px;">
		<div class="container-fluid">
		...
		<div class="alert alert-info clearfix jumbotron" style="position: absolute;top:200px ; right:50px ;width: 500px;height: 300px;">
			<h4>&nbsp;</h4>
