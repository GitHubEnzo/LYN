...
<!--                商品管理-->
    ...
    <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
        ...
        <li class="active">
            <a href="<?php echo u('edit')?>">添加编辑</a>
        </li>

    </ol>
    <ul class="nav nav-tabs" role="tablist">
        <li><a href="<?php echo u('index')?>">分类首页</a></li>
        <li class="active"><a href="<?php echo u('edit')?>">编辑分类</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="newcname"  class="form-control" value="<?php echo $olddata['cname']?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="js-example-basic-single form-control" name="tid">
                            ...
                            <option value="<?php echo $v['tid']?>" <?php if($v['tid'] ==Q('get.tid')){?>
                selected
               <?php }?>><?php echo $v['tname']?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="newsort"  class="form-control" value="<?php echo $olddata['sort']?>">
                    </div>
                </div>
            </div>
        </div>
