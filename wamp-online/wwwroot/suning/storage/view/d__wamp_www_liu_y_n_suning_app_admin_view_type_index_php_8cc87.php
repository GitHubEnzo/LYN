...
<!--                商品管理-->
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="<?php echo u('index')?>">类型管理</a></li>
        <li><a href="<?php echo u('add')?>">类型添加</a></li>
    </ul>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="divider"></li>
                                    <li><a href="<?php echo u('del',[tid=>$v['tid']])?>">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
