...
<!--                商品管理-->
    ...
    <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
        ...
        <li class="active">
            <a href="<?php echo u('index')?>">货品列表</a>
        </li>
    </ol>
    <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="<?php echo u('index')?>">货品列表</a></li>
        <li><a href="<?php echo u('add',['gid'=>Q('get.gid')])?>">货品添加</a></li>
    </ul>
                ...
                <table class="table table-hover">
                    ...
                    <?php if(!empty($data)){ foreach ($data as $k=>$v){?>
                        <tr style="text-align: center">
                            ...
                            <?php if(!empty($v['combine'])){ foreach ($v['combine'] as $kk=>$vv){?>
                                <td width="200"><?php echo $vv?></td>
                            <?php }}?>
