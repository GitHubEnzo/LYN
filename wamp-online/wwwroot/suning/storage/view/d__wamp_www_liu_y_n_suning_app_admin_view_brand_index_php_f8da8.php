...
<!--                商品管理-->
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="<?php echo u('index')?>">品牌管理</a></li>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <table class="table table-hover">
                    ...
                    <?php if(!empty($data)){ foreach ($data as $k=>$v){?>
                        <tr style="text-align: center">
                            ...
                            <td>
                                <input type="text"  class="form-control" name="" value="<?php echo $v['sort']?>">
                            </td>
                            <td>
                                <?php if($v['ishot'] == 1){?>
               ...
               <?php }?>
                            ...
                            <td>
                                <img src="<?php echo $v['logo']?>" alt="" width="50" height="50">
                            </td>
                            <td>
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">操作 <span class="caret"></span></button>
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a href="<?php echo u('edit',['bid'=>$v['bid']])?>">编辑</a></li>
                                        <li class="divider"></li>
                                        <li><a href="<?php echo u('del',['bid'=>$v['bid']])?>">删除</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
