...
<html>
	<head>
		...
		<link rel="stylesheet" href="<?php echo __ROOT__?>/public/css/pay.css" />	
	</head>
	<body>
		<div class="header">
			...
			<div class="order">
				...
				<div class="order-wrapper">
					<div class="order-title">
						<p>订单号：<?php echo $data['number']?></p>
						<p>卖家昵称：苏宁自营 </p>
					</div>
					<div class="order-amount">
						<em><?php echo $data['total']?>.00</em>元
				...
				<div class="payMethod-box">
					<div class="payMethod-bank">
						<div class="banks">
							...
							<span class="pay-amount"><span>支付</span><em><?php echo $data['total']?>.68</em>元</span>
						</div>
					</div>
					...
					<div class="btn">
						<?php if($data["status"] == "未付款"){?>
                
						<a href="javascript:;" class="pays" value="<?php echo $data['number']?>">确认付款</a>					    												     
						<?php }else{?>
