        ...
        <div class="col-xs-12 col-sm-3 col-lg-2 left-menu">
            <div class="panel panel-default" id="menus" >
                ...
                <ul class="list-group menus collapse in" id="collapseExample">
                    <a href="<?php echo u('type.index')?>" class="list-group-item" >
                        <i class="fa fa-align-center" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        类型列表
                    </a>
                    <a href="<?php echo u('type.add')?>" class="list-group-item" >
...
<!--                品牌-->
                ...
                <ul class="list-group menus collapse in" id="collapseExample1">
                    <a href="<?php echo u('brand.index')?>" class="list-group-item" >
                        <i class="fa fa-align-center" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        品牌列表
                    </a>
                    <a href="<?php echo u('brand.add')?>" class="list-group-item" >
                        <i class="fa fa-arrows" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        品牌添加
                    </a>
...
<!--                商品管理-->
                ...
                <ul class="list-group menus collapse in" id="collapseExample5">
                    <a href="<?php echo u('goods.index')?>" class="list-group-item" >
                        <i class="fa fa-align-center" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        商品列表
                    </a>
                    <a href="<?php echo u('goods.add')?>" class="list-group-item" >
                        <i class="fa fa-arrows" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        商品添加
                    </a>
                ...
                <ul class="list-group menus collapse in" id="collapseExample6">
                    <a href="<?php echo u('shops.index')?>" class="list-group-item" >
                        <i class="fa fa-align-center" aria-hidden="true"></i>
                        <span class="pull-right" href=""></span>
                        订单列表
                    </a>
