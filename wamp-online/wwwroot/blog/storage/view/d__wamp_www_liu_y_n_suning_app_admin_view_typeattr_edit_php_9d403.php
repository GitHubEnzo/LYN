...
<!--                商品管理-->
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li><a href="<?php echo u('index')?>">类型属性管理</a></li>
        <li class="active"><a href="<?php echo u('edit')?>">编辑属性类型</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="newname"  class="form-control" value="<?php echo $olddata['taname']?>">
                    </div>
                </div>
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="newvalue"  class="form-control" value="<?php echo $olddata['tavalue']?>">
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <label class="radio-inline">
                        <input type="radio" value="1" name="newclass" <?php if($olddata['class'] == 1){?>
                checked
               <?php }?>><i></i> 规格
                    </label>
                    <label class="radio-inline">
                        <input type="radio" value="2" name="newclass" <?php if($olddata['class'] == 2){?>
                checked
               <?php }?> ><i></i> 属性
                    </label>
                </div>
