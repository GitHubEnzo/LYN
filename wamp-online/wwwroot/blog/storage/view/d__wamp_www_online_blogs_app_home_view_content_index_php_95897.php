...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/online/blogs/resource/home/org/bootstrap-3.3.5-dist/css/bootstrap.min.css" />
    <script src="http://localhost/online/blogs/resource/home/js/jquery-1.11.3.min.js" type="text/javascript" charset="utf-8"></script>
    <script src="http://localhost/online/blogs/resource/home/org/bootstrap-3.3.5-dist/js/bootstrap.min.js" type="text/javascript" charset="utf-8"></script>
    <link rel="stylesheet" type="text/css" href="http://localhost/online/blogs/resource/home/css/index.css" />
    <link rel="stylesheet" type="text/css" href="http://localhost/online/blogs/resource/home/css/backTop.css"/>
</head>
<body>
<header>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12" >
                ...
                <div class="collapse navbar-collapse" id="example-navbar-collapse">
                    <ul class="_menu" >
                        <li  ><a href="http://localhost/online/blogs/">首页</a></li>
	...
	<main class="col-md-8">
		<article>
			...
			<div class="_footer">
				...
				<?php if(!empty($ArticleData['tag'])){foreach ($ArticleData['tag'] as $v){?>
				<a href="tag_<?php echo $v['tid']?>.html"><?php echo $v['tname']?></a>
				<?php }}?>
			</div>
		</article>
		<!-- 多说评论框 start -->
		<div class="ds-thread" data-thread-key="<?php echo $ArticleData['aid']?>" data-title="<?php echo $ArticleData['title']?>" data-url="<?php echo $ArticleData['author']?>"></div>
		<!-- 多说评论框 end -->
...
<!--返回顶部自己写的插件-->
<script src="http://localhost/online/blogs/resource/home/js/backTop.js" type="text/javascript" charset="utf-8"></script>
<script type="text/javascript">
    $(function(){
        //插件使用
