...
<!--                商品管理-->
    ...
    <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
        ...
        <li class="active">
            <a href="<?php echo u('add',['tid'=>Q('get.tid')])?>">类型属性添加</a>
        </li>

    </ol>
    <ul class="nav nav-tabs" role="tablist">
        <li class="active"><a href="<?php echo u('index')?>">类型属性管理</a></li>
        <li><a href="<?php echo u('add',['tid'=>Q('get.tid')])?>">类型属性添加</a></li>
    </ul>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a href="<?php echo u('edit',[taid=>$v['taid'],'tid'=>Q('get.tid')])?>">编辑</a></li>
                                    <li class="divider"></li>
                                    <li><a href="<?php echo u('del',[taid=>$v['taid']])?>">删除</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
