...
<!--                商品管理-->
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li><a href="<?php echo u('index')?>">类型管理</a></li>
        <li class="active"><a href="<?php echo u('edit')?>">编辑类型</a></li>
    </ul>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="newname"class="form-control" value="<?php echo $olddata['tname']?>">
                    </div>
                </div>
