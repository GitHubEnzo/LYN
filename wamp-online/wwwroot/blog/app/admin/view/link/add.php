        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="lname"  class="form-control" placeholder="网站名称">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">链接地址</label>
                    <div class="col-sm-9">
                        <input type="text" name="url"  class="form-control" placeholder="http://www.hdphp.com">
                    </div>
                </div>
...
<!--                单图上传-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="sort"  class="form-control" placeholder="请填写分类名称">
                    </div>
                </div>
