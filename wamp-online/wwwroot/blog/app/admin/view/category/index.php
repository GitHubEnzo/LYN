...
<script>
    function del(cid) {
        var obj = util.modal({
            title: '确定删除吗',//标题
            content: '',//内容
            footer: '<button type="button" class="btn btn-default " data-dismiss="modal">关闭</button><button type="button" class="btn btn-danger confirm" data-dismiss="modal">确认</button>',//底部
            width: 600,//宽度
            events: {
                confirm: function () {
